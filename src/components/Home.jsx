                  ...
                  <div className="item">
                    ...
                    <div className="info">
                      ...
                      <p>
                        ...
                        are but and certainty earnestly enjoyment.
                      </p>
              ...
              <div className="top-cat-items">
                <div className="col-md-3 col-sm-6 equal-height">
                  <div
                    className="item"
                    style={{
                      backgroundImage: "url(assets/img/category/1.jpg)",
                    }}
                  >
                    <a href="#">
                ...
                <div className="col-md-3 col-sm-6 equal-height">
                  <div
                    className="item"
                    style={{
                      backgroundImage: "url(assets/img/category/2.jpg)",
                    }}
                  >
                    <a href="#">
                ...
                <div className="col-md-3 col-sm-6 equal-height">
                  <div
                    className="item"
                    style={{
                      backgroundImage: "url(assets/img/category/3.jpg)",
                    }}
                  >
                    <a href="#">
                ...
                <div className="col-md-3 col-sm-6 equal-height">
                  <div
                    className="item"
                    style={{
                      backgroundImage: "url(assets/img/category/4.jpg)",
                    }}
                  >
                    <a href="#">
                      <i className="flaticon-education" />
                ...
                <div className="col-md-3 col-sm-6 equal-height">
                  <div
                    className="item"
                    style={{
                      backgroundImage: "url(assets/img/category/5.jpg)",
                    }}
                  >
                    <a href="#">
                ...
                <div className="col-md-3 col-sm-6 equal-height">
                  <div
                    className="item"
                    style={{
                      backgroundImage: "url(assets/img/category/6.jpg)",
                    }}
                  >
                    <a href="#">
                ...
                <div className="col-md-3 col-sm-6 equal-height">
                  <div
                    className="item"
                    style={{
                      backgroundImage: "url(assets/img/category/7.jpg)",
                    }}
                  >
                    <a href="#">
                ...
                <div className="col-md-3 col-sm-6 equal-height">
                  <div
                    className="item"
                    style={{
                      backgroundImage: "url(assets/img/category/8.jpg)",
                    }}
                  >
                    <a href="#">
                  ...
                  <div className="item">
                    ...
                    <div className="info">
                      ...
                      <p>
                        ...
                        happiness something the partiality unaffected
                      </p>
                      <a href="#">
