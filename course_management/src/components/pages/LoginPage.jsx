...
// import { useAuth } from "./AuthProvider"; // Adjust the path as per your file structure
  ...
  const handleLogin = async (event) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setToken(response.data.token); // Update context with new token
        setAccountId(response.data.accountid); // Update context with new account id
