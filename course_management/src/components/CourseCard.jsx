...
import { updateCollectionNullId } from '../services/CollectionServices'; // Thay đổi đường dẫn đến service của bạn
...
const CourseCard = ({ id, price, name, description, author }) => {
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await updateCollectionNullId(id, accessToken);
      if (response.data) {
